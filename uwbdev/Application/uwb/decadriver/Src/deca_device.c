...
/*! ------------------------------------------------------------------------------------------------------------------
 * @brief this function reads the dgc decision when RX_TUNING is enabled
 *
 * input parameters
 * no input parameters
 *
 * output parameters
 *
 * @param uint8_t The index value to be used in RX level and FP level formulas // str 80
 */
...
{
	 dwt_and8bitoffsetreg(TEST_CTRL0_ID, 0x0, TEST_CTRL0_TX_PSTM_BIT_OFFMASK);
}
